...
//在下面的空格按题目要求输出结果
    cout << fixed << setprecision(2) << r2.getPerimeter() << endl;
    cout << fixed << setprecision(2) << r2.getArea() << endl;
    cout << fixed << setprecision(2) << 2*r2.getPerimeter() << endl;
    cout << fixed << setprecision(2) << 2*r2.getArea() << endl;
